define(function (require, exports, module) {
    ...
    /**
     * Make an absolute URI absolute from document.location.href
     * @param {String} uri
     * @returns The absolute URI from document.location.href, striping down the
     * querystring and hashtag
     */
    var makeAbsolute = exports.makeAbsolute = function(uri) {
        var m = match(uri);
        return m[5];
    };
